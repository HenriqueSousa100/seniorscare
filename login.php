						...
						<div class="carousel-caption">
							<div class="wow fadeInUp testa" data-wow-offset="0" data-wow-delay="0.5s">
								<div class="titulo-text">
									...
									<br>
									<br>
									<h2>Login do Cuidador:</h2>
								</div>
								<form action="fazlogin.php" enctype="multipart/form-data" method="POST">
									<div class="formulario">
										<div class="formulario-login">	<span>Email:</span>
										</div>
										<input type="email" maxlength="50" title="Seu email de cadastro" placeholder="ex: Seniorscare@gmail.com" class="form-control input-color" name="email" id="email" required="required">
									</div>
									<div class="formulario">
										<div class="formulario-login2"><span>Senha:</span>
										</div>
										<input type="password" maxlength="8" title="Senha de 8 digitos" placeholder="ex: senior1234" class="form-control input-color" name="senha" id="senha" required="required">
									
										</div>
									
									<button type="submit" name="entrar" id="entrar" class="btnlog btn-primarylog btn-lg " required="required">Entrar</button>
						
								</form>
								<form action ="cadastro.php">
								<button type="submit" name="ircadastro" class="btnlog btn-primarycad btn-cad ">Cadastre-se</button>
								</form>
								<form action ="pedesenha.php">
								<button type="submit" name="recuperar" class="btnlog btn-primarycad btn-rec ">Esqueceu sua senha ?</button>
								</form>
							</div>
						</div>
						</div>
