            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li type="button" class="default" action="index.php" ><a href="duvida.php">Dúvidas?</a></li>
					...
					<div class="item active">						
						...
						<div class="carousel-caption">
							...
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">								
								<p>*Em breve atendimento via e-mail.</p>
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="text-center">
					...
					<p>Com a SeniorsCare você sempre terá um profissional para cuidar de quem você ama. Garantimos a qualidade do serviço com os melhores cuidadadores de idosos, a nossa intenção é fazer com que você ache um profissional de maneira simples e rápida.</p>
